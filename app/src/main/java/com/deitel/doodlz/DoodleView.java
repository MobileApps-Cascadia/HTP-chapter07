...
public class DoodleView extends View
{
   ...
   private final Paint paintRec; // rectanle paint object
   private final Paint paintOval; // oval paint object

   // starting and ending coordinates for rectangle and oval
   ...
   public DoodleView(Context context, AttributeSet attrs)
   {
      ...
      // set the initial display settings for the painted rectangle
      paintRec = new Paint();
      paintRec.setColor(Color.MAGENTA);
      paintRec.setStyle(Paint.Style.STROKE); // solid line
      paintRec.setStrokeWidth(5); // set the default line width

      // set the initial display settings for the painted oval
      paintOval = new Paint();
      paintOval.setColor(Color.BLUE);
      paintOval.setStyle(Paint.Style.STROKE); // solid line
      paintOval.setStrokeWidth(5); // set the default line width
   ...
   public int getBackgroundColor()
   {
      ...
      //((ColorDrawable) backgroundColorDialogView.getBackground()).getColor();
      return cd.getColor();
   ...
   private void touchStarted(float x, float y, int lineID)
   {
      ...
      // store the starting coordinates of the touch for rectangle draw
      startX = point.x;
      startY = point.y;
      ...
      for (int i = 0; i < event.getPointerCount(); i++)
      {
         ...
         if (pathMap.containsKey(pointerID))
         {
            ...
            if (deltaX >= TOUCH_TOLERANCE || deltaY >= TOUCH_TOLERANCE)
            {
               ...
               // store the ending coordinates of the touch for rectangle draw
               endX = point.x;
               endY = point.y;
            }
         }
   ...
   public void drawRectangle()
   {
      // for each path currently being drawn
      for (Integer key : pathMap.keySet())
         bitmapCanvas.drawRect(startX, startY, endX, endY, paintRec); // draw rectangle
   }
   ...
   public void drawOval()
   {
      ...
      for (Integer key : pathMap.keySet())
      {
         ...
         bitmapCanvas.drawOval(oval, paintOval); // draw oval
      }
   }
